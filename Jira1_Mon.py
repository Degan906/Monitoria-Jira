...
if not st.session_state.authenticated:
    ...
    if menu_option == "Dash de monitoria":
        ...
        queries = {
            "🤖 AUTOMAÇÕES AP 🤖": {
                "Testes Jira" : 'created >= "2025-02-12" AND project = JSM ORDER BY created DESC',
        ...
        st.write("Conteúdo da fila de atendimento...")  # Conteúdo do dashboard
        st.write("Esta seção está em desenvolvimento. Volte mais tarde!")
